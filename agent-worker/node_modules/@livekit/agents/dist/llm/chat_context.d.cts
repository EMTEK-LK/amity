...
export declare class AgentConfigUpdate {
    readonly id: string;
...
export declare class ChatContext {
    ...
    toProviderFormat(format: ProviderFormat, injectDummyUserMessage?: boolean): Promise<Record<string, any>[] | [Record<string, unknown>[], import("./provider_format/google.js").GoogleFormatData] | [Record<string, unknown>[], import("./provider_format/mistralai.js").MistralFormatData]>;
    /**
