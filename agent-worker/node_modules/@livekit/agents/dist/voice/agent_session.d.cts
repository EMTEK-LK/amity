...
export declare class AgentSession<UserData = UnknownUserData> extends AgentSession_base {
    ...
    /** @internal */
    _onError(error: RealtimeModelError | STTError | TTSError | LLMError | InterruptionDetectionError): void;
    /** @internal */
